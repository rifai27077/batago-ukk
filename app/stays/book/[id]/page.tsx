...
import GuestDetailsForm from "@/components/stays/book/GuestDetailsForm";
import StaysPaymentMethods from "@/components/stays/book/StaysPaymentMethods";
import StaysBookingInfoCard from "@/components/stays/book/StaysBookingInfoCard";

export default function StaysBookingPage() {
  return (
    <div className="min-h-screen bg-gray-50/50 flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 lg:px-6 py-8 pt-24 lg:pt-32">
        ...
        <div className="flex items-center gap-2 text-sm text-muted mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <Link href="/stays/detail/1" className="hover:text-primary transition-colors">Detail</Link>
            <ChevronRight className="w-4 h-4" />
