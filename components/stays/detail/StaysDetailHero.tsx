...
import { Share2, Heart, MapPin, ChevronLeft, ChevronRight, Star } from "lucide-react";

interface StaysDetailHeroProps {
  title: string;
  address: string;
  rating: number;
  reviews: number;
...
export default function StaysDetailHero({
  title,
  address,
  rating,
  reviews,
    ...
    <section className="pt-28 pb-8 px-4 lg:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <Link href="/stays/list" className="flex items-center gap-1 text-sm font-bold text-foreground hover:text-primary transition-colors">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
          ...
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="flex items-center gap-4">
              <div className="px-3 py-1.5 bg-primary text-white text-sm font-bold rounded-[4px] shadow-sm shadow-primary/20 flex items-center gap-1">
          ...
          <div className="flex flex-col items-start lg:items-end gap-4 shrink-0">
            <div className="text-right">
              ...
              <span className="text-xs font-bold text-foreground/40 block mt-1">/night excl. tax</span>
            </div>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <button className="w-12 h-12 rounded-[4px] border border-foreground/10 flex items-center justify-center text-foreground hover:bg-primary/5 hover:text-primary hover:border-primary/20 transition-all duration-300 group shadow-sm">
                ...
                <Link href="/stays/book/1" className="bg-primary hover:bg-primary-hover text-white px-8 py-3 rounded-[4px] font-semibold transition-all shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 flex items-center justify-center gap-2 w-full md:w-auto active:scale-95">
                  Book now
                </Link>
            </div>
          </div>
