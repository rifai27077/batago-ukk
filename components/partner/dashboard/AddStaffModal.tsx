...
export default function AddStaffModal({ isOpen, onClose, onSave }: AddStaffModalProps) {
  ...
  const roles = partnerType === "hotel" 
    ? [
        { id: "manager", label: "General Manager" },
        { id: "receptionist", label: "Receptionist" },
        { id: "housekeeping_head", label: "Head of Housekeeping" },
        { id: "finance", label: "Finance Officer" },
      ]
    : [
        { id: "station_manager", label: "Station Manager" },
        { id: "check_in_agent", label: "Check-in Agent" },
        { id: "crew_scheduler", label: "Crew Scheduler" },
        { id: "finance", label: "Finance Officer" },
      ];
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-2">
              {roles.map((role) => (
                ...
                >
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${formData.role === role.label ? "bg-primary text-white" : "bg-gray-100 dark:bg-slate-800 text-gray-400"}`}>
