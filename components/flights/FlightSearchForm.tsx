...
export default function FlightSearchForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-5xl mx-auto relative z-10 font-sans">
        {/* Header/Tabs Placeholder to match style if needed, or just padding */}
        <div className="bg-primary/5 border-b border-primary p-4 flex items-left justify-left gap-2 text-primary font-bold">
