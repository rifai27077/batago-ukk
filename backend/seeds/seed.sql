...
-- Run with: psql $DATABASE_URL -f backend/seeds/seed.sql

-- ======================
-- PARTNERS (Airlines & Hotel Chains)
-- ======================
INSERT INTO partners (company_name, type, status, created_at, updated_at) VALUES
...
-- CITIES
-- ======================
INSERT INTO cities (name, country, image_url, is_popular, created_at, updated_at) VALUES
('Jakarta', 'Indonesia', 'https://images.unsplash.com/photo-1555899434-94d1368aa7af?w=800', TRUE, NOW(), NOW()),
('Bali', 'Indonesia', 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800', TRUE, NOW(), NOW()),
('Yogyakarta', 'Indonesia', 'https://images.unsplash.com/photo-1584810359583-96fc3448beaa?w=800', TRUE, NOW(), NOW()),
('Surabaya', 'Indonesia', 'https://images.unsplash.com/photo-1621274283991-0a60c3100b79?w=800', TRUE, NOW(), NOW()),
('Bandung', 'Indonesia', 'https://images.unsplash.com/photo-1604310383708-c862f95b3abe?w=800', TRUE, NOW(), NOW()),
('Malang', 'Indonesia', 'https://images.unsplash.com/photo-1588668214407-6ea9a6d8c272?w=800', FALSE, NOW(), NOW()),
('Lombok', 'Indonesia', 'https://images.unsplash.com/photo-1570789210967-2cac24ba04c0?w=800', TRUE, NOW(), NOW()),
('Medan', 'Indonesia', 'https://images.unsplash.com/photo-1609607849457-28fc7f92e8a7?w=800', FALSE, NOW(), NOW()),
('Makassar', 'Indonesia', 'https://images.unsplash.com/photo-1625736180498-fce7362cdd13?w=800', FALSE, NOW(), NOW()),
('Semarang', 'Indonesia', 'https://images.unsplash.com/photo-1623492229905-3c9ed2ef396e?w=800', FALSE, NOW(), NOW())
ON CONFLICT DO NOTHING;

-- ======================
-- AIRPORTS
-- ======================
INSERT INTO airports (code, name, city, country, timezone, created_at, updated_at) VALUES
...
-- FACILITIES
-- ======================
INSERT INTO facilities (name, icon, created_at, updated_at) VALUES
...
-- ======================
INSERT INTO flights (partner_id, flight_number, airline, departure_airport_id, arrival_airport_id, departure_time, arrival_time, duration, baggage_allowance_kg, created_at, updated_at) VALUES
-- Garuda Indonesia flights
(1, 'GA-401', 'Garuda Indonesia', 1, 2, NOW() + INTERVAL '2 days' + TIME '06:00', NOW() + INTERVAL '2 days' + TIME '08:50', 110, 30, NOW(), NOW()),
(1, 'GA-402', 'Garuda Indonesia', 2, 1, NOW() + INTERVAL '2 days' + TIME '14:00', NOW() + INTERVAL '2 days' + TIME '16:30', 110, 30, NOW(), NOW()),
(1, 'GA-201', 'Garuda Indonesia', 1, 3, NOW() + INTERVAL '3 days' + TIME '07:30', NOW() + INTERVAL '3 days' + TIME '08:40', 70, 30, NOW(), NOW()),
(1, 'GA-301', 'Garuda Indonesia', 1, 4, NOW() + INTERVAL '3 days' + TIME '10:00', NOW() + INTERVAL '3 days' + TIME '11:30', 90, 30, NOW(), NOW()),
(1, 'GA-501', 'Garuda Indonesia', 4, 2, NOW() + INTERVAL '5 days' + TIME '08:00', NOW() + INTERVAL '5 days' + TIME '09:30', 90, 30, NOW(), NOW()),
-- Lion Air flights
(2, 'JT-690', 'Lion Air', 1, 2, NOW() + INTERVAL '2 days' + TIME '09:00', NOW() + INTERVAL '2 days' + TIME '11:40', 100, 20, NOW(), NOW()),
(2, 'JT-691', 'Lion Air', 2, 1, NOW() + INTERVAL '2 days' + TIME '17:00', NOW() + INTERVAL '2 days' + TIME '19:30', 100, 20, NOW(), NOW()),
(2, 'JT-570', 'Lion Air', 1, 4, NOW() + INTERVAL '4 days' + TIME '06:30', NOW() + INTERVAL '4 days' + TIME '08:00', 90, 20, NOW(), NOW()),
(2, 'JT-580', 'Lion Air', 4, 1, NOW() + INTERVAL '4 days' + TIME '16:00', NOW() + INTERVAL '4 days' + TIME '17:30', 90, 20, NOW(), NOW()),
(2, 'JT-250', 'Lion Air', 1, 3, NOW() + INTERVAL '5 days' + TIME '12:00', NOW() + INTERVAL '5 days' + TIME '13:10', 70, 20, NOW(), NOW()),
-- Citilink flights
(3, 'QG-800', 'Citilink', 1, 2, NOW() + INTERVAL '3 days' + TIME '05:30', NOW() + INTERVAL '3 days' + TIME '08:10', 100, 20, NOW(), NOW()),
(3, 'QG-801', 'Citilink', 2, 1, NOW() + INTERVAL '3 days' + TIME '19:00', NOW() + INTERVAL '3 days' + TIME '21:30', 100, 20, NOW(), NOW()),
(3, 'QG-610', 'Citilink', 4, 2, NOW() + INTERVAL '4 days' + TIME '13:00', NOW() + INTERVAL '4 days' + TIME '14:30', 90, 20, NOW(), NOW()),
(3, 'QG-340', 'Citilink', 1, 8, NOW() + INTERVAL '6 days' + TIME '08:00', NOW() + INTERVAL '6 days' + TIME '10:30', 150, 20, NOW(), NOW()),
-- Batik Air flights
(4, 'ID-6570', 'Batik Air', 1, 2, NOW() + INTERVAL '2 days' + TIME '15:00', NOW() + INTERVAL '2 days' + TIME '17:40', 100, 30, NOW(), NOW()),
(4, 'ID-6571', 'Batik Air', 2, 1, NOW() + INTERVAL '2 days' + TIME '20:00', NOW() + INTERVAL '2 days' + TIME '22:30', 100, 30, NOW(), NOW()),
(4, 'ID-7300', 'Batik Air', 1, 7, NOW() + INTERVAL '5 days' + TIME '11:00', NOW() + INTERVAL '5 days' + TIME '13:30', 150, 30, NOW(), NOW()),
-- AirAsia flights
(5, 'QZ-7520', 'AirAsia Indonesia', 1, 2, NOW() + INTERVAL '3 days' + TIME '11:30', NOW() + INTERVAL '3 days' + TIME '14:10', 100, 15, NOW(), NOW()),
(5, 'QZ-7521', 'AirAsia Indonesia', 2, 1, NOW() + INTERVAL '3 days' + TIME '16:30', NOW() + INTERVAL '3 days' + TIME '19:00', 100, 15, NOW(), NOW()),
(5, 'QZ-8400', 'AirAsia Indonesia', 4, 7, NOW() + INTERVAL '7 days' + TIME '14:00', NOW() + INTERVAL '7 days' + TIME '15:20', 80, 15, NOW(), NOW())
ON CONFLICT DO NOTHING;
...
INSERT INTO flight_seats (flight_id, class, price, total_seats, available_seats, features) VALUES
...
-- HOTELS
-- ======================
INSERT INTO hotels (partner_id, name, city_id, description, address, rating, total_reviews, created_at, updated_at) VALUES
...
-- HOTEL IMAGES
-- ======================
INSERT INTO hotel_images (hotel_id, url, is_primary) VALUES
-- The Mulia Resort (id=1)
(1, 'https://images.unsplash.com/photo-1582719508461-905c673771fd?w=800', TRUE),
(1, 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800', FALSE),
(1, 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=800', FALSE),
-- AYANA Resort (id=2)
(2, 'https://images.unsplash.com/photo-1540541338287-41700207dee6?w=800', TRUE),
(2, 'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=800', FALSE),
-- Kempinski Jakarta (id=3)
(3, 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800', TRUE),
(3, 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800', FALSE),
-- Padma Resort Legian (id=4)
(4, 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=800', TRUE),
(4, 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800', FALSE),
-- Tugu Hotel Malang (id=5)
(5, 'https://images.unsplash.com/photo-1445019980597-93fa8acb246c?w=800', TRUE),
-- Mulia Jakarta (id=6)
(6, 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=800', TRUE),
-- AYANA Komodo (id=7)
(7, 'https://images.unsplash.com/photo-1573843981267-be1999ff37cd?w=800', TRUE),
-- Padma Ubud (id=8)
(8, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800', TRUE),
-- Tentrem Yogya (id=9)
(9, 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=800', TRUE),
-- Plataran Bromo (id=10)
(10, 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=800', TRUE)
ON CONFLICT DO NOTHING;
...
-- ROOM TYPES
-- ======================
INSERT INTO room_types (hotel_id, name, description, size_m2, max_guests, base_price, features, created_at, updated_at) VALUES
-- The Mulia Resort
...
-- Generate availability for the next 30 days for each room type
DO $$
DECLARE
    room RECORD;
    d DATE;
BEGIN
    FOR room IN SELECT id, base_price FROM room_types LOOP
        FOR d IN SELECT generate_series(CURRENT_DATE, CURRENT_DATE + INTERVAL '30 days', '1 day')::date LOOP
            INSERT INTO room_availabilities (room_type_id, date, available_rooms, price_override)
            VALUES (
                room.id,
                d,
                FLOOR(RANDOM() * 5 + 2)::int, -- 2-6 available rooms
                CASE
                    -- Weekend markup 20%
                    WHEN EXTRACT(DOW FROM d) IN (0, 6) THEN room.base_price * 1.2
                    ELSE NULL
                END
            )
            ON CONFLICT DO NOTHING;
